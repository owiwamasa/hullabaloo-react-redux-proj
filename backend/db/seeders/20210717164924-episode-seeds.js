    ...
    return queryInterface.bulkInsert('Episodes', [
      {
        ...
        mp3: 'https://hullabaloo-mp3s.s3.us-east-2.amazonaws.com/The+Midnight+Miracle+Podcast+Ep+1+How+to+Inspire+(Side+A)+Subscribe+Now+For+More+Episodes.mp3',
        totalPlays: 124,
      ...
      },
      {
        ...
        mp3: 'https://hullabaloo-mp3s.s3.us-east-2.amazonaws.com/George+Lopez+Has+a+Haunting+TigerBelly+291.mp3',
        totalPlays: 201,
      ...
      },
      {
        ...
        mp3: 'https://hullabaloo-mp3s.s3.us-east-2.amazonaws.com/Monday+Morning+Podcast+7-12-21.mp3',
        totalPlays: 134,
      ...
      },
      {
        ...
        mp3: 'https://hullabaloo-mp3s.s3.us-east-2.amazonaws.com/%23054+BERT+KREISCHER+UNCLE+JOEYS+JOINT+with+JOEY+DIAZ.mp3',
        totalPlays: 144,
      ...
      },
      {
        ...
        mp3: 'https://hullabaloo-mp3s.s3.us-east-2.amazonaws.com/George+Lopez+Podcast+OMG+Hi!+Ep+18+Gil+Carrillo+%26+Ben+Bray+Hernandez.mp3',
        totalPlays: 172,
        releaseDate: new Date(2021, 6, 28),
        podcastId: 5,
        userId: 6,
      ...
      },
      {
        ...
        mp3: "https://hullabaloo-mp3s.s3.us-east-2.amazonaws.com/Your+Mom's+House+Podcast+-+Ep.+584.mp3",
        totalPlays: 133,
      ...
      },
      {
        ...
        mp3: 'https://hullabaloo-mp3s.s3.us-east-2.amazonaws.com/Nikkis+DIY+Bachelor+Spin-Off+-+You+Up+w+Nikki+Glaser.mp3',
        totalPlays: 159,
      ...
      },
      {
        ...
        mp3: 'https://hullabaloo-mp3s.s3.us-east-2.amazonaws.com/%23116--Good+Little+Piggy.mp"https://hullabaloo-mp3s.s3.us-east-2.amazonaws.com/Riffin+With+Griffin+Episode+142.mp3"',
        totalPlays: 110,
        releaseDate: new Date(2021, 7, 12),
        podcastId: 8,
        userId: 9,
      ...
      },
      {
        ...
        mp3: "https://hullabaloo-mp3s.s3.us-east-2.amazonaws.com/Riffin+With+Griffin+Episode+142.mp3",
        totalPlays: 121,
        releaseDate: new Date(2021, 7, 12),
        podcastId: 9,
        userId: 10,
      ...
      },
      {
        ...
        mp3: "https://hullabaloo-mp3s.s3.us-east-2.amazonaws.com/T-Pain+-+Steve-O's+Wild+Ride!+Ep+%2360.mp3",
        totalPlays: 111,
        releaseDate: new Date(2021, 7, 15),
        podcastId: 10,
        userId: 11,
